# start executing cells from here to rewrite submission_v32.py
...
# "%%writefile -a submission_v32.py" will append the code below to submission_v32.py,
# it WILL NOT rewrite submission_v32.py
