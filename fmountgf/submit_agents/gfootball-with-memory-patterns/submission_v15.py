# start executing cells from here to rewrite submission_v15.py
...
# "%%writefile -a submission_v15.py" will append the code below to submission_v15.py,
# it WILL NOT rewrite submission_v15.py
