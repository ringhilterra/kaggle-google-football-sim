# start executing cells from here to rewrite submission_v41.py
...
# "%%writefile -a submission_v41.py" will append the code below to submission_v41.py,
# it WILL NOT rewrite submission_v41.py
