# start executing cells from here to rewrite submission_v43.py
...
# "%%writefile -a submission_v43.py" will append the code below to submission_v43.py,
# it WILL NOT rewrite submission_v43.py
